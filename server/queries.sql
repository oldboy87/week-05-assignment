...
-- TODO: Add an entry
INSERT INTO inventory (item_name, date_added, quantity, unit_type, category, subcategory, storage_location, expiry_date, comments) VALUES 
('testItem', '2025-12-16', 10, 'L', 'beverages', 'can drinks', 'pantry', '2027-12-01', 'testComment')

-- above translated into generic code for JS use
`INSERT INTO inventory (item_name, date_added, quantity, unit_type, category, subcategory, storage_location, expiry_date, comments) VALUES ($1, $2, $3, $4, $5, $6, $7, $8, $9)`,
